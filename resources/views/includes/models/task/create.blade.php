...
<div class="modal fade" id="create-task-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" id="create_task_form" class="create_form" data-target="{{$target}}" data-array='@json($my_array)'>
                        @csrf
                        <div class="row">
                        ...
                        <div class="float-right">
                            ...
                            <button type="submit" id="create_task_btn" data-route="{{ route('task-create') }}" class="btn-modern btn-success">{{ __('Submit') }}</button>
                        </div>
                    </form>
                </div>
            </div>
