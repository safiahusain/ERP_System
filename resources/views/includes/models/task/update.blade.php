...
@endphp
<div class="modal" tabindex="-1" id="update-task-modal" role="dialog" aria-labelledby="pendingTransactionModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" id="update-task-form" class="update_form" data-target="{{$target}}" data-array='@json($my_array)'>
                        @csrf
                        <div class="row">
                        ...
                        <div class="float-right">
                            ...
                            <button type="submit" id="update_task_btn" class="btn-modern btn-success">{{ __('Submit') }}</button>
                        </div>
                    </form>
                </div>
            </div>
